<template>
  <div>
  <div class="container">
    <h1 class="headline">TRA<strong style="color: orange">V</strong>AGIR</h1>
    <h1 class="subheadline">Choose your next destination</h1>
...
.container {
  ...
  padding: 20px;
  height: 500px;
  background-color: rgba(83, 83, 76, 0.5);
  position: relative;
  display: flex;
  flex-direction: column;
  align-items: center;
